...
var C = {
	...
	initEvent: function() {
		var self = this;
		self.commentBtnO.click(function() {
		    if(!self.visitUserInfo.UserId) {
		    if(typeof visitUserInfo == "undefined" || !visitUserInfo || !visitUserInfo.UserId) {
            		...
            		var textVal = '<a href="' + loginUrl + '" style="color:#00b494;font-weight:500;">Sign in</a> to leave a comment. <br/>No Leanote account ? <a href="' + registerUrl +'" style="color:#00b494;font-weight:500;">Sign up now</a>.';
            		try {
            		    swal({
            		        title : "",
            		        text : textVal,
                  ...
                  var height = $("#commentArea").offset().top-50;
    		      $('html, body').animate({
                        scrollTop: height
                    }, 888); 
                    $("textarea").focus();
		...
		self.likeBtnO.click(function() {
			if(!self.visitUserInfo.UserId) {
			    ...
			    if(typeof visitUserInfo == "undefined" || !visitUserInfo || !visitUserInfo.UserId) {
            		...
            		var loginUrl = siteUrl + '/login?from=' + encodeURI(location.href);
            		var registerUrl = siteUrl + '/register?from=' + encodeURI(location.href);
            		var textVal = 'Please <a href="' + loginUrl + '" style="color:#00b494;font-weight:500;">sign in</a> first. <br/>No Leanote account ? <a href="' + registerUrl +'" style="color:#00b494;font-weight:500;">Sign up now</a>.';
            		try {
            		    swal({
            		        title : "",
            		        text : textVal,
